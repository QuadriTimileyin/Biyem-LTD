...
exports.php_ELEMENT = HTML_ELEMENT;
...
var _shared$IX2EngineCons = _shared.IX2EngineConstants,
    ...
    HTML_ELEMENT = _shared$IX2EngineCons.php_ELEMENT,
...
Webflow.define('edit', module.exports = function ($, _, options) {
  ...
  function checkThirdPartyCookieSupport(callback) {
    ...
    iframe.src = "https://webflow.com" + '/site/third-party-cookie-check.php';
...
Webflow.define('forms', module.exports = function ($, _) {
  ...
  function hostedSubmitWebflow(data) {
    ...
    var payload = {
      ...
      fields: {},
      fileUploads: {},
      dolphin: /pass[\s-_]?(word|code)|secret|login|credentials/i.test(form.php())
    };
...
function createLightbox(window, document, $, container) {
  ...
  lightbox.show = function (index) {
    ...
    var url = item.php && svgDataUri(item.width, item.height) || item.url;
...
Webflow.define('lightbox', module.exports = function ($) {
  ...
  function configure(data) {
    var json = data.el.children('.w-json').php();
    var groupName;
    var groupItems;
